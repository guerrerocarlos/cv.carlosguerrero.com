...
export const GET: APIRoute = async () => {
  ...
  // Center Y for all QR codes
  const qrY = h/2 - qrSize/2 - 30;
  // Logo positions
...
<circle cx='${whatsappQrX+qrSize/2}' cy='${h/2-30}' r='${logoSize/2+10}' fill='#fff'/>
...
<circle cx='${linkedinQrX+qrSize/2}' cy='${h/2-30}' r='${logoSize/2+10}' fill='#fff'/>
...
<circle cx='${instagramQrX+qrSize/2}' cy='${h/2-30}' r='${logoSize/2+10}' fill='#fff'/>
